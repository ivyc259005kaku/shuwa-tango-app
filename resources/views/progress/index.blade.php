...
<div class="max-w-md mx-auto space-y-6">
    ...
    <div class="text-center">
        ...
        <p class="text-gray-500 dark:text-gray-300 text-sm mt-1">全体の {{ $masteredPercent }}%</p>
    </div>
    ...
    {{-- 内訳 --}}
    <div class="space-y-2">
        <div class="flex items-center justify-between border-2 border-gray-300 px-4 py-3">
